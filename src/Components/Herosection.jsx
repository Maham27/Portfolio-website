...
<Navbar/>
    <div className="h-screen flex flex-col justify-center items-center  text-white relative px-4 overflow-hidden font-sans">
      ...
      <motion.div
        ...
        className="absolute bottom-10 flex justify-center w-full z-10"
      >
